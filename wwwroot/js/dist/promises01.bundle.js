...
/***/ function(module, exports) {
	...
	var getJson = function getJson(url) {
	    return get(url).then(function (jsonResult) {
	        return JSON.parse(jsonResult);
	    });
	};
	
	getJson('./promiseland.json').then(function (story) {
	    story.chapterUrls.map(getJson).reduce(function (current, next) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=promises01.bundle.js.map